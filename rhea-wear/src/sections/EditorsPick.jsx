  ...
  return (
    <div className="pt-32 sm:px-10  px-40">
      ...
      <div className="flex  sm:flex-col justify-center h-auto sm:items-center space-x-4">
        <div className="relative w-full sm:pl-2 sm:w-96 sm:h-80 h-[500px] overflow-hidden mb-0">
          <img
        ...
        <div className="relative w-full sm:w-96 sm:h-80 h  h-[500px] left-0  overflow-hidden ">
          <img
      ...
      <div className="flex sm:gap-4  sm:flex-col h-[500px] sm:h-auto sm:items-center space-x-4">
        <div className="relative w-full sm:w-96 sm:h-80 h-[500px] overflow-hidden ">
          <img
            src="/assets/editors1.png"
            className="w-full h-full  object-cover"
          />
        ...
        <div className="w-full sm:gap-4  flex flex-col space-y-4">
          <div className="relative sm:w-96 sm:h-80 w-full h-[243px] overflow-hidden">
            <img
              src="/assets/editors3.png"
              className="w-full h-full object-cover object-top"
            />
          ...
          <div className="relative w-full sm:w-96 sm:h-80 h-[243px]  overflow-hidden">
            <img
              src="/assets/editors4.png"
              className="w-full h-full object-cover"
            />
