  ...
  return (
    <div className="mx-36 my-7">
      <div>
        ...
        <nav className=" sm:text-[#737373] grid grid-cols-1 justify-items-center pt-5 font-5xl sm:grid-cols-6  gap-y-4 sm:gap-y-0 sm:gap-x-8">
          <NavLink
            to="/"
            className="text-gray-300 sm:text-[#737373] sm:pr-1 py-2 rounded-md text-sm font-medium  "
